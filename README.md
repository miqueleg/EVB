...
Q-region EVB architecture and validation are documented in [`docs/q_region_evb.md`](docs/q_region_evb.md). HG3.17 Q-region calibration to the user-provided g-xTB profile is documented in [`docs/hg317_qregion_gxtb_calibration.md`](docs/hg317_qregion_gxtb_calibration.md), and longer calibrated-candidate stability checks are documented in [`docs/hg317_qregion_stability.md`](docs/hg317_qregion_stability.md).
