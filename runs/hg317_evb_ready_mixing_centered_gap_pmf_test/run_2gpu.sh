...
run_root="runs/hg317_evb_ready_mixing_centered_gap_pmf_test"
...
run_replica "$run_root/configs/rep01.yaml" 0 "outputs/hg317_evb_ready_mixing_centered_gap_pmf_test/rep01" &
pid0=$!
run_replica "$run_root/configs/rep02.yaml" 1 "outputs/hg317_evb_ready_mixing_centered_gap_pmf_test/rep02" &
pid1=$!

wait "$pid0"
wait "$pid1"

echo "[$(date -Is)] HG3.17 EVB-ready mixing-centered gap PMF test complete"
